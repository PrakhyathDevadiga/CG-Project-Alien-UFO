...
ufo(){
	...
	glTranslatef(70.0+x1,102-y1,0.0);
	glScalef(1,0.50,1);
	...
	glTranslatef(70.0+x1,100.0-y1,0.0);
	glScalef(1,0.24,1);
...
void ufowindow(){
	...
	glPointSize(10);
	glBegin(GL_POINTS);
	glVertex2f(54+x1,103-y1);
	glVertex2f(58+x1,104-y1);
	glVertex2f(62+x1,105-y1);
	glVertex2f(66+x1,106-y1);
	glVertex2f(70+x1,106.5-y1);
	glVertex2f(74+x1,106-y1);
	glVertex2f(78+x1,105-y1);
	glVertex2f(82+x1,104-y1);
	glVertex2f(86+x1,103-y1);
	glEnd();		
}
